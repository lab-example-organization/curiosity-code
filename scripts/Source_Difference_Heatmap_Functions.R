...
(variance scale)")
  ...
  if (legend_scale == "midpoint") {
    ...
    axis (1, c(4, 11, 18, 25, 32, 39, 46, 50.5, 55, 62, 69, 76, 83, 90, 97), c("0.01", "0.034", "0.058", "0.082", "0.106", "0.130", "0.15", "0.165", "0.17", "0.20", "0.22", "0.24", "0.26", "0.28", "0.3"),T,-11.85,NA,F,cex.axis = 0.7, tck = -0.015)
  }
