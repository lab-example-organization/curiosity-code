...
plot(x[,1], x[,2], col = colorseqmultpalette[[19]](100), pch = 26, cex = 1, axes = F, xlab = "", ylab = "")
plot(x[,1], x[,2], col = colorseqmultpalette[[19]](100), pch = 27, cex = 1, axes = F, xlab = "", ylab = "")
plot(x[,1], x[,2], col = colorseqmultpalette[[19]](100), pch = 28, cex = 1, axes = F, xlab = "", ylab = "")
plot(x[,1], x[,2], col = colorseqmultpalette[[19]](100), pch = 29, cex = 1, axes = F, xlab = "", ylab = "")
plot(x[,1], x[,2], col = colorseqmultpalette[[19]](100), pch = 30, cex = 1, axes = F, xlab = "", ylab = "")
...
axis(1, c(0.5, 7.5, 14.5, 21.5, 28.5, 35.5, 42.5, 49.5, 51.5, 58.5, 65.5, 72.5, 79.5, 86.5, 93.5, 100.5), c("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""),T,-12.3,NA,F,cex.axis = 0.7, tck = -0.015)
...
title(xlab = c("-1     -0.86    -0.72   -0.58   -0.44     -0.3     -0.16  -0.02  0.02   0.16     0.3     0.44      0.58      0.72    0.86         1 "), line = -12, cex.lab = 0.7)
...
axis(1, c(0.5, 7.5, 14.5, 21.5, 28.5, 35.5, 42.5, 49.5, 51.5, 58.5, 65.5, 72.5, 79.5, 86.5, 93.5, 100.5), c("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""),T,-13.5,NA,F,cex.axis = 0.7, tck = 0.015)
title(xlab = c("-155     -133     -111      -89       -67      -45      -23        -3  3         23       45        67        89       111       133      155 "), line = -15, cex.lab = 0.7)

# c("", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "")

title(xlab = c("Syllable Repertoire Differences"), line = -16, cex.lab = 0.7)
title(xlab = c("Curiosity Level Differences"), line = -11, cex.lab = 0.7)
