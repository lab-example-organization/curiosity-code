                ...
                if (as.numeric (first_term[[1]][1]) + 1 < as.numeric(secnd_term[[1]][1])) {
                    ...
                    if (as.numeric (first_term[[1]][2]) < 9) {
                        ...
                        # 1XY where Y == 9
                            ...
                            # append "Y_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4"
                            output_object <- append (output_object, paste0 (first_term[[1]][3], "_|*_", first_term[[1]][1], "[", as.numeric (first_term[[1]][2]) + 1, "-9][0-9]_|*_[", as.numeric (first_term[[1]][1]) + 1, "-", as.numeric (secnd_term[[1]][1]) - 1, "][0-9][0-9]_|*_", secnd_term[[1]][1]))
                            # 4Z where Z > 0
                            if (as.numeric (secnd_term[[1]][2]) > 0) {
                                # append "[0-(Z-1)][0-9]_|*_4Z" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z"
                                output_object <- append (output_object, paste0 ("[0-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                                # 4ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 4ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z0_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            # 4Z where Z == 0
                            } else {
                                # append "0" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_40"
                                output_object <- append (output_object, paste0 (secnd_term[[1]][2]))
                                # 4ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1X[Y-9]_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_40[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 4ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1X[Y-9]_|*_1[(X+1)-9][0-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_400_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            }
                        }
                    # 1X where X == 9
                        ...
                        # 1XY where Y < 9
                        if (as.numeric (first_term[[1]][3]) < 9) {
                            # append "[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4"
                            output_object <- append(output_object, paste0 ("[", first_term[[1]][3], "-9]_|*_[", as.numeric (first_term[[1]][1]) + 1, "-", as.numeric (secnd_term[[1]][1]) - 1, "][0-9][0-9]_|*_", secnd_term[[1]][1]))
                            # 4Z where Z > 0
                            if (as.numeric (secnd_term[[1]][2]) > 0) {
                                # append "[0-(Z-1)][0-9]_|*_4Z" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z"
                                output_object <- append (output_object, paste0 ("[0-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                                # 4ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 4ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z0_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            # 4Z where Z == 0
                            } else {
                                # append "0" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_40"
                                output_object <- append (output_object, paste0 (secnd_term[[1]][2]))
                                # 4ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_40[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 4ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1X[Y-9]_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_400_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            }
                        # 1XY where Y == 9
                        } else if (as.numeric (first_term[[1]][3]) == 9) {
                            # append "Y_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4"
                            output_object <- append (output_object, paste0 (first_term[[1]][3], "_|*_[", as.numeric (first_term[[1]][1]) + 1, "-", as.numeric (secnd_term[[1]][1]) - 1, "][0-9][0-9]_|*_", secnd_term[[1]][1]))
                            # 4Z where Z > 0
                            if (as.numeric (secnd_term[[1]][2]) > 0) {
                                # append "[0-(Z-1)][0-9]_|*_4Z" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z"
                                output_object <- append (output_object, paste0 ("[0-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                                # 4ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 4ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_4[0-(Z-1)][0-9]_|*_4Z0_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            # 4Z where Z == 0
                            } else {
                                # append "0" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_40"
                                output_object <- append (output_object, secnd_term[[1]][2])
                                # 4ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_40[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 4ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1XY_|*_[(1+1)-(4-1)][0-9][0-9]_|*_400_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            }
                        }
                ...
                # 1XY-2ZA
                    ...
                    if (as.numeric (first_term[[1]][2]) < 9) {
                        ...
                        # 1XY where Y == 9
                            ...
                            output_object <- append (output_object, paste0 (first_term[[1]][3], "_|*_", first_term[[1]], "[", as.numeric (first_term[[1]][2]) + 1, "-9][0-9]_|*_", secnd_term[[1]][1]))
                            # 2ZA where Z > 0
                            if (as.numeric (secnd_term[[1]][2]) > 0) {
                                # append "0[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z"
                                output_object <- append (output_object, paste0 ("0[0-9]_|*_", secnd_term[[1]][1], "[1-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                                # 2ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 2ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1XY_|*_1[(X+1)-9][0-9]_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z0_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            # 2ZA where Z == 0
                            } else {
                    ...
                    # 1XY where X == 9
                        ...
                        #1XY where Y is less than 9
                        if (as.numeric (first_term[[1]][3]) < 9) {
                            # append "[Y-9]_|*_2" ### "*_1X[Y-9]_|*_2"
                            output_object <- append (output_object, paste0 ("[", first_term[[1]][3], "-9]_|*_", secnd_term[[1]][1]))
                            # 2ZA where Z > 0
                            if (as.numeric (secnd_term[[1]][2]) > 0) {
                                # append "0[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z" ### "*_1X[Y-9]_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z"
                                output_object <- append (output_object, paste0 ("0[0-9]_|*_", secnd_term[[1]][1], "[1-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                                # 2ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1X[Y-9]_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 2ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1X[Y-9]_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z0_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            # 2ZA where Z == 0
                            } else {
                                # append "0" ### "*_1X[Y-9]_|*_20"
                                output_object <- append (output_object, paste0 ("0"))
                                # 2ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### *_1X[Y-9]_|*_20[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 2ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1X[Y-9]_|*_200_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            }
                        ...
                        # 1XY where Y == 9
                            ...
                            # append "Y_|*_2" ### "1XY_|*_2"
                            output_object <- append (output_object, paste0 (first_term[[1]][3], "_|*_", secnd_term[[1]][1]))
                            # 2ZA where Z > 0
                            if (as.numeric (secnd_term[[1]][2]) > 0) {
                                # append "0[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z" ### "*_1XY_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z"
                                output_object <- append (output_object, paste0 ("0[0-9]_|*_", secnd_term[[1]][1], "[1-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                                # 2ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### "*_1XY_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 2ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1XY_|*_20[0-9]_|*_2[1-(Z-1)][0-9]_|*_2Z0_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            # 2ZA where Z == 0
                            } else {
                                ...
                                # 2ZA where A > 0
                                if (as.numeric (secnd_term[[1]][3]) > 0) {
                                    # append "[0-A]_" ### *_1XY_|*_20[0-A]_"
                                    output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                                # 2ZA where A == 0
                                } else {
                                    # append "0_" ### "*_1XY_|*_200_"
                                    output_object <- append (output_object, paste0 ("0_"))
                                }
                            }
                        }
                ...
                # 1XY-1ZA
                    ...
                    if (as.numeric (first_term[[1]][2]) + 1 < as.numeric(secnd_term[[1]][2])) {
                        ...
                        # 11X where X = 9
                            ...
                            # append "1X_|*_1[(1+1)-(4-1)][0-9]_|*_14" ### "*_11X_|*_1[(1+1)-(4-1)][0-9]_|*_14"
                            output_object <- append (output_object, paste0 (first_term[[1]][2], first_term[[1]][3], "_|*_", first_term[[1]][1], "[", as.numeric (first_term[[1]][2]) + 1, "-", as.numeric (secnd_term[[1]][2]) - 1, "][0-9]_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                            # 14X where X > 0
                            if (as.numeric (secnd_term[[1]][3]) > 0) {
                                # append "[0-X]_" ### "*_11X_|*_1[(1+1)-(4-1)][0-9]_|*_14[0-X]_"
                                output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                            # 14X where X = 0
                            } else {
                                # append "0_" ### "*_11X_|*_1[(1+1)-(4-1)][0-9]_|*_140_"
                                output_object <- append (output_object, "0_")
                            }
                        }
                    # 11X-12X
                        ...
                        # 11X where X = 9
                            ...
                            # append "19_|*_12" ### "*_119_|*_12"
                            output_object <- append (output_object, paste0 (first_term[[1]][2], first_term[[1]][3], "_|*_", secnd_term[[1]][1], secnd_term[[1]][2]))
                            # 12X where X > 0
                            if (as.numeric (secnd_term[[1]][3]) > 0) {
                                # append "[0-X]_" ### "*_119_|*_12[0-X]_"
                                output_object <- append (output_object, paste0 ("[0-", secnd_term[[1]][3], "]_"))
                            # 12X where X = 0
                            } else {
                                # append "0_" ### "*_119_|*_120_"
                                output_object <- append (output_object, paste0("0_"))
                            }
                        }
                    # 11X -11Y
                    ...
                    if (as.numeric (first_term[[1]][2]) < 9) {
                        ...
                        if (as.numeric (first_term[[1]][3]) < 9) {
                            ...
                            # 1ABC where C == 9
                                ...
                                # append "" ### "" YOU STOPPED HERE; JUST FILL IN THE PSEUDOCODE FOR THE REST OF 4 DIGITS, AND WRITE THE REAL CODE LATER
                                # 4DEF where D > 0
                                if (as.numeric (secnd_term[[1]][2]) > 0) {
                                    # 4DEF where E > 0
                                    if (as.numeric (secnd_term[[1]][3]) > 0) {
