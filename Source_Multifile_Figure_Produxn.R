...
for(multiple_files in 1:mult_file_length) {
  ...
  thing <- paste0("converted_data", 1:mult_file_length, " <- convert_stored_data(P = P, num_timechunks = thousand_timesteps)")
  ...
  stuff <- paste("sink(file = ", paste0("\"", 1:mult_file_length, " - Parameters and Info\"),"), "print(", sep = "\n")
