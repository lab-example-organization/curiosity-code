...
for(thousand_timesteps in 1:(P$num_timesteps/1000)) {
  for(single_timestep in 1:1000) {
    ...
    P$offspring_calls <- make.offspring.calls(P, no.parent.turnover = FALSE)
    ...
    P$curiosity_level <- curiosity_learn(P, curlearnprob = 0.95, timestep = single_timestep, curinh.row = 1) 
