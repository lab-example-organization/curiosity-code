...
rm(list=objects())
thing <- getwd()
init_params <- paste0("source(\"", thing, "/", "180812", ".", "1211", "_Source_Initial_Functions_Parameters.R\")")
...
funx_n_params <- paste0("source(\"", thing, "/", "180812", ".", "1342", "_Source_Functions_Parameters.R\")")
